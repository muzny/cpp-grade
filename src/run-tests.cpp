...
TEST_CASE("Unit tests run test case 2", "[meta]" ) {
  ...
  SECTION("second test case adds on") {
    ...
    REQUIRE( 1 == 1 );
    jao.UpdateTestCase("Unit tests successfully include files # 2 2", 1, "This test ran successfully");
  }
}
